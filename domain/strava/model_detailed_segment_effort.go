...
type DetailedSegmentEffort struct {
	...
	AverageHeartrate float64 `bson:"average_heartrate" json:"average_heartrate,omitempty"`
	// The maximum heart rate of the athlete during this effort
	MaxHeartrate float64         `bson:"max_heartrate" json:"max_heartrate,omitempty"`
	Segment      *SummarySegment `bson:"segment" json:"segment,omitempty"`
	// The rank of the effort on the global leaderboard if it belongs in the top 10 at the time of upload
	KomRank int64 `bson:"kom_rank" json:"kom_rank,omitempty"`
	// The rank of the effort on the athlete's leaderboard if it belongs in the top 3 at the time of upload
	PrRank int64 `bson:"pr_rank" json:"pr_rank,omitempty"`
