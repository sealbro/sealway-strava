...
type DetailedClub struct {
	...
	Membership string `bson:"membership" json:"membership,omitempty"`
	// Whether the currently logged-in athlete is an administrator of this club.
	Admin bool `bson:"admin" json:"admin,omitempty"`
	// Whether the currently logged-in athlete is the owner of this club.
	Owner bool `bson:"owner" json:"owner,omitempty"`
	// The number of athletes in the club that the logged-in athlete follows.
	FollowingCount int32 `bson:"following_count" json:"following_count,omitempty"`
}
