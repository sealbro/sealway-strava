...
type DetailedAthlete struct {
	...
	FollowerCount int32 `bson:"follower_count" json:"follower_count,omitempty"`
	// The athlete's friend count.
	FriendCount int32 `bson:"friend_count" json:"friend_count,omitempty"`
	// The athlete's preferred unit system.
	MeasurementPreference string `bson:"measurement_preference" json:"measurement_preference,omitempty"`
	// The athlete's FTP (Functional Threshold Power).
	Ftp int32 `bson:"ftp" json:"ftp,omitempty"`
	// The athlete's weight.
	Weight float32 `bson:"weight" json:"weight,omitempty"`
	// The athlete's clubs.
	Clubs []SummaryClub `bson:"clubs" json:"clubs,omitempty"`
	// The athlete's bikes.
	Bikes []SummaryGear `bson:"bikes" json:"bikes,omitempty"`
	// The athlete's shoes.
	Shoes []SummaryGear `bson:"shoes" json:"shoes,omitempty"`
}
